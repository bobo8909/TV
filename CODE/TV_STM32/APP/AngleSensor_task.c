...
*/
    ...
    if ((BackupPWM3OUT2 != PWM3OUT2) || (BackupPWM5OUT2 != PWM5OUT2))
	{
...
//		printf("P = %d\r\n", (BackupPWM3OUT2 * 10000 / ARR_1KHz));
    ...
    if (BackupPWM3OUT2 != PWM3OUT2) 
	{
		...
		//printf("P = %d\r\n", 10000 - (BackupPWM3OUT2 * 10000 / ARR_1KHz));
	...
	if(BackupPWM5OUT2 != PWM5OUT2)
	{
		...
		//TIM_SetCompare1(TIM4, BackupPWM4OUT2);	
		printf("S = %d\r\n", BackupPWM5OUT2);
		//printf("S = %d\r\n", (BackupPWM5OUT2 * 10000 / ARR_200Hz));
...
//        BackupPWM4OUT2 = BackupPWM4OUT2+690;
        //BackupPWM4OUT2 = BackupPWM4OUT2+1180;
		PWM4OUT2 = 0;
//		printf("T1 = %d\r\n", BackupPWM4OUT2*10000/ARR_2KHz);	
//		printf("T1 = %d\r\n", BackupPWM4OUT2);	
        //TIM_SetCompare1(TIM4,BackupPWM4OUT2);
		...
		//else
		{
			SendVal = BackupPWM4OUT2 * ARR_2KHz / TIM_SEND_RESOLUTION ;
...
//        BackupPWM2OUT4 = BackupPWM2OUT4 + 600;
        //BackupPWM2OUT4 = BackupPWM2OUT4 + 1000;
		PWM5OUT2 = 0;
//        printf("T2 = %d\r\n", BackupPWM2OUT4);
//		printf("T2 = %d\r\n", BackupPWM2OUT4*10000/ARR_2140Hz);
        //TIM_SetCompare3(TIM2,  BackupPWM2OUT4);    
		...
		//else
		{
			SendVal = BackupPWM2OUT4 * ARR_2140Hz / TIM_SEND_RESOLUTION;
...
//	}
	...
	if(g_VCU5RecvVal.DRIVING_MODE.bits.b_DrivingMode == AUTOMATIC_DRIVING)
	{
		...
		PWMVal[3] = ((u32)g_VCU3RecvVal.EPSMomentalSig2HIGH << 8 | g_VCU3RecvVal.EPSMomentalSig2LOW) * ARR_2140Hz / TIM_SEND_RESOLUTION;
		
		//TIM_SetCompare1(TIM4, PWMVal[0]);		   
		//TIM_SetCompare3(TIM2, PWMVal[1]);		   
        TIM_SetCompare1(TIM4,PWMVal[2]);
        TIM_SetCompare3(TIM2,PWMVal[3]);    
        T1T2flag = 1;
